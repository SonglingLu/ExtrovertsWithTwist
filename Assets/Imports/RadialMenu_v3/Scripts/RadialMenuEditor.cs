...
namespace Rito.RadialMenu_v3.Editor
{
    ...
    public class RadialMenuEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty _pieceInstance;
        ...
        private SerializedProperty _radialMenuCenter;

        //private SerializedProperty iconFinalScale;
        ...
        private void OnEnable()
        {
            ...
            try
            {
                ...
                _pieceInstance = serializedObject.FindProperty(nameof(_pieceInstance));
                ...
                _radialMenuCenter = serializedObject.FindProperty(nameof(_radialMenuCenter));
               // iconFinalScale = serializedObject.FindProperty(nameof(iconFinalScale));
            }
            catch
            {
                run = false;
        ...
        public override void OnInspectorGUI()
        {
            ...
            //EditorGUILayout.Slider(iconFinalScale, 0.01f, 50.0f, "Icon Final Scale");
            EditorGUILayout.Slider(_pieceDist, 1.0f, 300f, "Piece Distance From Center");
            EditorGUILayout.Slider(_centerRange, 0.01f, 10.0f, "Center Range");
            ...
            if (!EditorApplication.isPlaying)
            {
                ...
                EditorGUILayout.PropertyField(_pieceInstance);
                EditorGUILayout.PropertyField(_arrow);
                EditorGUILayout.PropertyField(_radialMenuCenter);
            }
