...
namespace Rito.RadialMenu_v3
{
    public partial class RadialMenu : MonoBehaviour
    {
        ...
        [SerializeField] private RectTransform _radialMenuCenter;
        ...
        ***********************************************************************/
        ...
        private abstract class MainState : MenuState
        {
            ...
            public override void OnEnter()
            {
                ...
                menu.SetAllPieceScale(1); //Change final icon scale here
            ...
            public override void Update()
            {
                ...
                Vector2 buttonPosition = Camera.main.ScreenToWorldPoint(menu._radialMenuCenter.position);
