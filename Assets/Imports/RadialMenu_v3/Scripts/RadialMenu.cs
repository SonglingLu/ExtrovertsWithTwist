...
namespace Rito.RadialMenu_v3
{
    ...
    public partial class RadialMenu : MonoBehaviour
    {
        //[Header("Options")]
        //[Range(2, 16)]
        [SerializeField] private int _pieceCount = 6; // 조각 개수
        ...
        //[Range(0.01f, 0.5f)]
        [SerializeField] private float _centerRange = 1f; // 커서 인식 안되는 중앙 범위

        //[Header("Objects")]
        [SerializeField] public RectTransform[] _pieceInstance; // 복제될 조각 게임오브젝트
        ...
        ***********************************************************************/
        ...
        private void InitPieceImages()
        {
            ...
            for (int i = 0; i < _pieceCount; i++)
            {
                ...
                _pieceImages[i] = _pieceInstance[i].GetComponentInChildren<Image>();
                _pieceRects[i] = _pieceInstance[i];
            }
        ...
        ***********************************************************************/
        ...
        public void SetPieceImageSprites(Image[] drawButtonToolImages)
        {
            int i = 0;
            int len = drawButtonToolImages.Length;
            for (; i < _pieceCount && i < len; i++)
            {
                if (drawButtonToolImages[i] != null)
                {
                    _pieceImages[i].sprite = drawButtonToolImages[i].sprite;
                }
            }
        }
